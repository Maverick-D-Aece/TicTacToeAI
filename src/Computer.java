...
public class Computer extends Player {
        ...
        try{
            for(int i=0;i<9;i++)
            {
                ...
                for(int j=0;j<l.nodes.size();j++)
                {
                    ...
                    p.println(s);
                    //p.println(temp.pref==null?0:temp.pref);
                    p.println(temp.n);
    ...
    public void makeNewMind(){
        ...
        for(int i9=0;i9<=2;i9++){
            ...
            if((x-o==0 || x-o==1) && l!=0 )
            {
                ...
                //System.out.print(id.equals("100000000")?"----------------------":"not");
            }
        }}}}}}}}} 
        for(int l=1;l<9;l++)
        {
    ...
    public void playTurn(int p,int turn){
        ...
        if(turn != 1)
        {
            current = layers.get(turn-2).searchByState(TicTacToe.state,t);
    ...
    void notifyWin(int pl){
        ...
        if(TicTacToe.rounds%1000==0)saveMind();
    }
    @Override
